...
**Commit messages MUST be written exclusively in English.** This overrides any
global or session language preference. The subject, body, and footer are all
English regardless of the language used to communicate with the user. Do not
translate or mix languages in the commit text.
